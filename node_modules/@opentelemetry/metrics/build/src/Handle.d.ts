 ...
 */
export declare class CounterHandle extends BaseHandle implements types.CounterHandle {
 ...
 */
export declare class GaugeHandle extends BaseHandle implements types.GaugeHandle {
    private readonly _disabled;
    private readonly _monotonic;
    private readonly _valueType;
    private readonly _logger;
 ...
 */
export declare class MeasureHandle extends BaseHandle implements types.MeasureHandle {
