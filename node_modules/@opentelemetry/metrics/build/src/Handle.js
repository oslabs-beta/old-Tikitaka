 ...
 */
class CounterHandle extends BaseHandle {
...
exports.CounterHandle = CounterHandle;
/**
 ...
 */
class GaugeHandle extends BaseHandle {
    constructor(labelSet, _disabled, _monotonic, _valueType, _logger, _onUpdate) {
        super(labelSet);
        this._disabled = _disabled;
        this._monotonic = _monotonic;
