 ...
 */
class NodeTracer extends tracing_1.BasicTracer {
    /**
    ...
    constructor(config = {}) {
        ...
        this._pluginLoader.load(config.plugins || config_1.DEFAULT_INSTRUMENTATION_PLUGINS);
    }
    stop() {
        this._pluginLoader.unload();
    }
}
exports.NodeTracer = NodeTracer;
//# sourceMappingURL=NodeTracer.js.map