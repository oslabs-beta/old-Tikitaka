...
class PluginLoader {
    ...
    constructor(registry, logger) {
         ...
         */
        this._hookState = HookState.UNINITIALIZED;
    }
    /**
    ...
    load(plugins) {
        if (this._hookState === HookState.UNINITIALIZED) {
            ...
            hook(modulesToHook, (exports, name, baseDir) => {
                ...
                if (!version)
                    return exports;
                this.logger.debug(`PluginLoader#load: applying patch to ${name}@${version} using ${modulePath} module`);
                // Expecting a plugin from module;
                try {
                    const plugin = require(modulePath).plugin;
